// Root entry point for Vercel — serves static files and routes API to api/index.js
// This file exists solely to satisfy Vercel's entrypoint requirement.
...
module.exports = async (req, res) => {
  try {
    ...
    if (base === 'data-store.json' || base === 'seed.js' || base === 'index.js' || base === 'server.js' || base === 'dev-server.js') {
      res.writeHead(403);
